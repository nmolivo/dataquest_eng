...
<img src = "https://github.com/nmolivo/dataquest_eng/blob/master/001_postgres.png?raw=true"></img>
Each line will start with whatever you named your database, so for me it's `valenbisi2018#=`<br><br>
