...
>The syntax for</i> `\COPY` <i>is slightly different: (a) being a psql command, it is not terminated by a semicolon (b) file >paths are relative the current working directory.<br><Br>
